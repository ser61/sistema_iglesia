...
<table align="center" style="margin-top: 10px">
  <tr>
	<td>
      {!!Form::model($persona,['route'=> ['persona.pdf',$persona->ci],'method'=>'GET'])!!}
	    <button class="btn btn-danger" type="submit" aria-label="Delete" name="bt" value="1">
	      Descargar PDF
	    </button>
	    <button class="btn btn-primary" type="submit" aria-label="Skip to main navigation" name="bt" value="2">
	      Visualizar PDF
	    </button>
	  {!! Form::close() !!}
	</td>
