...
@section('content')
  ...
  <div class="panel-heading" align="center" style="font-size: 20px">
    <strong>Formulario Para Editar Telefono de: {{ $persona->nombre }}</strong>
  </div>
  <div class="panel-body">
    {!! Form::model($telefono, ['route' => ['telefono.update', $telefono->cod],'method' => 'PUT']) !!}
    <br><br>
    <div class="row">
    ...
    <div class="form-group" align="center">
        {!! Form::submit('Actualizar numero de telefono' , ['class'=>'btn btn-primary btn-lg btn-block']) !!}
    </div>
    {!! Form::close() !!}  
  </div>
</div> 
