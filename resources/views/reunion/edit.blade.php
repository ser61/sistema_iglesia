...
@section('content')
  ...
  <div class="panel panel-primary">
      <div class="panel-heading" align="center" style="font-size: 20px">
          <strong>Formulario Para Editar Reunion</strong>
      </div>
      <div class="panel-body">
          ...
          <div class="row">
              <div class="col-lg-6" style="padding-left: 30px">
                  ...
                  <div class="input-group bootstrap-timepicker timepicker">
                      <input id="time1" name="horadeinicio" type="text"
                             class="form-control input-small" data-show-Meridian="false" data-default-Time="{{$reunion->horadeinicio}}">
              ...
              <div class="col-lg-6">
                  ...
                  <div class="input-group bootstrap-timepicker timepicker">
                      <input id="time2" name="horadefinal" type="text"
                             class="form-control input-small" data-show-Meridian="false" data-default-Time="{{$reunion->horadefinal}}">
                      <span class="input-group-addon"><i class="fa fa-clock-o"></i></span>
                  </div>
                  <span class="col-lg-6" style="color: #ff0000;">Dato obligatorio</span>
              </div><!-- /.col-lg-6 -->
          ...
          <div class="form-group" align="center">
              {!! Form::submit('Actualizar Reunion' , ['class'=>'btn btn-primary btn-lg btn-block']) !!}
          </div>
          {!! Form::close() !!}
      </div>
  </div>
